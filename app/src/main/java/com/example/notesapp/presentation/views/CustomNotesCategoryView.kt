...
class CustomNotesCategoryView(
    ...
    private fun initAttrs(attrs: AttributeSet?, defStyleAttr: Int, defStyleRes: Int) {
        ...
        val typedArray = context.obtainStyledAttributes(
            attrs,
            R.styleable.CustomNotesCategoryView,
            defStyleAttr,
            defStyleRes
        )
        with(binding) {
            ...
            val iconBackgroundColor =
                typedArray.getColor(R.styleable.CustomNotesCategoryView_category_color, -1)
            val categoryNotesBackgroundColor =
                typedArray.getColor(R.styleable.CustomNotesCategoryView_cardBackgroundColor, -1)
            val background =
                typedArray.getDrawable(R.styleable.CustomNotesCategoryView_category_background)
